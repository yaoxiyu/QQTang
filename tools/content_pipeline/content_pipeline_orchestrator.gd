...
const GenerateAudioAssetsScript = preload("res://tools/content_pipeline/generators/generate_audio_assets.gd")
const GenerateItemsScript = preload("res://tools/content_pipeline/generators/generate_items.gd")
const GenerateBattleItemsScript = preload("res://tools/content_pipeline/generators/generate_battle_items.gd")
const GeneratePlayerItemsScript = preload("res://tools/content_pipeline/generators/generate_player_items.gd")
...
func run_all() -> void:
	...
	GenerateAudioAssetsScript.new().generate()
	GenerateItemsScript.new().generate()
	GenerateBattleItemsScript.new().generate()
	GeneratePlayerItemsScript.new().generate()
