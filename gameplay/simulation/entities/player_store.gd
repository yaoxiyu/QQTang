...
func restore_player_from_snapshot(data: Dictionary) -> int:
	...
	player.move_remainder_units = int(data.get("move_remainder_units", 0))
	...
	player.max_speed_level = int(data.get("max_speed_level", player.max_speed_level))
	player.bomb_capacity = int(data.get("bomb_capacity", player.bomb_capacity))
	player.max_bomb_capacity = int(data.get("max_bomb_capacity", player.max_bomb_capacity))
	...
	player.trapped_timeout_ticks = int(data.get("trapped_timeout_ticks", 0))
