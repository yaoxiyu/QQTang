...
static func load_metadata(tile_id: String) -> Dictionary:
	...
	return {
		...
		"tile_category": tile_def.tile_category,
		...
		"movement_pass_mask": tile_def.movement_pass_mask,
		"blast_pass_mask": tile_def.blast_pass_mask,
		"can_spawn_item": tile_def.can_spawn_item,
		"occlusion_mode": tile_def.occlusion_mode,
