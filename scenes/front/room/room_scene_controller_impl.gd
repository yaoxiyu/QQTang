...
func _refresh_reference_room_panels(_snapshot: RoomSnapshot, _view_model: Dictionary) -> void:
	pass


func _refresh_formal_room_slots(_snapshot: RoomSnapshot, _view_model: Dictionary) -> void:
	pass


func _refresh_formal_room_actions(_snapshot: RoomSnapshot, _view_model: Dictionary) -> void:
	pass


func _refresh_formal_loadout_selection(_view_model: Dictionary) -> void:
	pass


func _resolve_formal_open_slot_count(_snapshot: RoomSnapshot, _view_model: Dictionary) -> int:
	return FORMAL_ROOM_SLOT_COUNT


func _is_local_host(_snapshot: RoomSnapshot) -> bool:
	return false


func _member_to_profile_payload(_member: RoomMemberState) -> Dictionary:
	return {}
