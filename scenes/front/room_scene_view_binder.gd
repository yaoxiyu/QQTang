...
func apply_room_kind_visibility(scene_controller: Node, view_model: Dictionary) -> void:
	...
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/MapRow", is_custom_room or is_assigned_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/RuleRow", is_custom_room or is_assigned_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/ModeRow", is_custom_room or is_assigned_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/LocalLoadoutCard/LocalLoadoutVBox/TeamRow", is_custom_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/MatchFormatRow", is_match_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/MatchModeRow", is_match_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/InviteRow", is_match_room)
	_set_node_visible(scene_controller, "RoomRoot/MainLayout/RoomSelectionCard/RoomSelectionVBox/QueueStatusRow", is_match_room)
