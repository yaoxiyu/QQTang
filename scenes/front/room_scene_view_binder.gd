...
func apply_room_kind_visibility(scene_controller: Node, view_model: Dictionary) -> void:
	...
	_set_node_visible(scene_controller, "RoomRoot/RoomScroll/MainLayout/RoomSelectionCard/RoomSelectionVBox/MapRow", is_custom_room)
	_set_node_visible(scene_controller, "RoomRoot/RoomScroll/MainLayout/RoomSelectionCard/RoomSelectionVBox/RuleRow", is_custom_room)
	_set_node_visible(scene_controller, "RoomRoot/RoomScroll/MainLayout/RoomSelectionCard/RoomSelectionVBox/ModeRow", is_custom_room)
