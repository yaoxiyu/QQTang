...
class FrontSceneContractTests(unittest.TestCase):
    ...
    def test_room_loading_shop_inventory_are_formalized(self) -> None:
        ...
        self.assertIn("_refresh_formal_room_slots", room_controller)
        self.assertIn("_toggle_formal_slot", room_controller)
        self.assertIn("_formal_closed_slots", room_controller)
        self.assertIn("_show_formal_member_profile", room_controller)
        self.assertIn("_change_formal_character_page", room_controller)
        ...
        self.assertIn("_apply_room_small_button_style", room_controller)
        self.assertIn("_apply_room_square_button_style", room_controller)
        self.assertIn("_color_for_character_id", room_controller)
        self.assertIn("RoomCharacterPreviewScene", room_controller)
        self.assertIn("_add_formal_character_preview", room_controller)
        self.assertIn("_on_formal_choose_mode_pressed", room_controller)
        self.assertIn("_on_formal_room_property_pressed", room_controller)
        self.assertIn("_on_formal_choose_map_pressed", room_controller)
        self.assertIn("_select_formal_custom_map", room_controller)
        self.assertIn("_select_formal_match_mode", room_controller)
        self.assertIn('"选择模式"', room_controller)
        self.assertIn('"竞技模式"', room_controller)
        self.assertIn('"探险模式"', room_controller)
        self.assertIn('"房间属性"', room_controller)
        self.assertIn('"选择地图"', room_controller)
        self.assertIn('"房间聊天"', room_controller)
        self.assertIn('"角色选择"', room_controller)
        self.assertIn('"队伍选择"', room_controller)
        self.assertIn('"离开房间"', room_controller)
