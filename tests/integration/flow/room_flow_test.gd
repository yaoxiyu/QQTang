...
func _test_match_start_config_debug_dump_is_read_only() -> void:
	...
	coordinator.match_id_prefix = "room_flow"
	...
	snapshot.members.assign(members)
...
func _test_front_flow_accepts_loading_payload() -> void:
	...
	var payload := {"match_id": "room_flow_payload_test", "seed": 77}
...
func _make_member(peer_id: int, player_name: String, ready: bool, slot_index: int = -1):
