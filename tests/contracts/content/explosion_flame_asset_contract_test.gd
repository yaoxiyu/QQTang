...
const MANIFEST_PATH := "res://assets/animation/explosions/normal/explosion_normal_segments.json"
const SEGMENTS_DIR := "res://assets/animation/explosions/normal/segments/"
