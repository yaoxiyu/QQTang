...
introduces this schema as the formal packed wire contract between GDScript battle runtime code and `qqt_native` kernels.
...
does not require replacing all simulation objects with structure-of-arrays data. The intended migration path is:
