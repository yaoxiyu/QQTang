...
This is a system design and performance-hardening scope after the native kernel rollout.

This scope does not add gameplay, redesign UI, rewrite DS lifecycle, or remove the GDScript simulation fallback. It keeps the current main flow and hardens the runtime boundaries that already exist.

## Truth

- This scope does not change the main business flow and does not add new gameplay.
