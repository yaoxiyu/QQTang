...
## Purpose
记录 2026-04-22 双客户端实测中出现的 battle 过程中 Room 状态回流问题，说明前因后果、当前短期保护、为什么它不满足 Current 目标态，以及后续正确落地路径。
...
`F:\Obsidian\02-项目\QQ堂重置\31_Current_状态机收敛工程化方案\02_Current_详细工程化系统设计.md`
