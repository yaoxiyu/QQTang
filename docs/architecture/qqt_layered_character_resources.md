...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/content/scan_qqt_object_resources.ps1 -SourceRoot "res\object"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/content/bake_qqt_layered_characters.ps1
```
