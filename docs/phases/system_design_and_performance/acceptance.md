...
- `docs/phases/system_design_and_performance/README.md`
- `docs/phases/system_design_and_performance/front_context.md`
- `docs/phases/system_design_and_performance/system_design.md`
- `docs/phases/system_design_and_performance/implementation_plan.md`
- `docs/phases/system_design_and_performance/acceptance.md`
