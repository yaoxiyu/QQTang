...
Scope: current repository implementation after directory governance and single-path convergence.
...
- Manual acceptance: [`docs/manual_acceptance.md`](./manual_acceptance.md)
...
4. State-machine governance must keep contract guardrails green:
...
8. Runtime/front boundary truth:
