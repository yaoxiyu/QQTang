...
- Added release hygiene script and aligned checks to Phase27 policy:
  - `tools/release/release_sanity_check.py`
- Added formal validation entrypoint:
  - `scripts/validation/run_phase27_validation.ps1`
- Added CI entrypoint:
  - `.github/workflows/phase27_validate.yml`

## 4. Latest Report Paths
- `tests/reports/latest/phase27_validation_latest.txt`
- `tests/reports/latest/phase27_validation_latest.json`
...
## 6. Next Suggestions
- Keep `run_phase27_validation.ps1` as the single formal validation entry in all current docs.
