# Service Migration Worklog

## Step 0
- Date: 2026-04-19
- Branch: room-go-protobuf
- Status: completed
...
- New Room features must go to the Go + protobuf + C# path.
...
- Added service compose files:
  - `deploy/docker/docker-compose.services.dev.yml`
  - `deploy/docker/docker-compose.services.test.yml`
